...
import TesteContext from '../../views/examples2/TesteContext'
import TesteReducer from '../../views/examples2/TesteReducer'
...
const Content = props => (
    <main className="Content">
        <Switch>
            ...
            <Route path="/testeContext">
                <TesteContext />
            </Route>
            <Route path="/testeReducer">
                <TesteReducer />
            </Route>
            <Route path="*">
                <NotFound />
